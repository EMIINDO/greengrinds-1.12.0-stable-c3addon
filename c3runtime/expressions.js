"use strict";
{
    globalThis.C3.Plugins.open_Greengrinds.Exps = {
        ...
        GetMicroTxnAuthorizationResponse()
        {
            return JSON.stringify(this.microTxnAuthorizationResponse);
        },
        ...
        GetEncryptedAppTicketResponse()
        {
            //implementation
            return this._encryptedAppTicketResponse;
        },

        GetEncryptedAppTicketTimestamp()
        {
            return this._encrypedAppTicketTimestamp;
        }
    };
}