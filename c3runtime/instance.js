...
const properties = this._getInitProperties();
            ...
            this._uiLang = "";
            this._ipCountry = "";
            this._encryptedAppTicketResponse = "";
            this._encrypedAppTicketTimeout = 0;
            ...
            this.AddDOMMessageHandlers([
                ["micro-txn-authorization-response", e => this._OnMicroTxnAuthorizationResponse(e)]
            ]);

            this.AddDOMMessageHandlers([
                ["request-encrypted-app-ticket-response", e => this._OnRequestEncryptedAppTicketResponse(e)]
            ]);
        ...
        _OnMicroTxnAuthorizationResponse(e)
        {
            console.log("*** INFO *** _OnMicroTxnAuthorizationResponse", e);
            this.microTxnAuthorizationResponse = e;
            this._trigger(globalThis.C3.Plugins.open_Greengrinds.Cnds.OnMicroTxnAuthorizationResponse);
        }

       _OnRequestEncryptedAppTicketResponse(e)
        {
            console.log("*** INFO *** _OnRequestEncryptedAppTicketResponse", e);
            this._encryptedAppTicketResponse = e.ticketString;
            this._encrypedAppTicketTimestamp = Date.now();
            this._trigger(globalThis.C3.Plugins.open_Greengrinds.Cnds.OnRequestEncryptedAppTicketResponse);
        }
    };
